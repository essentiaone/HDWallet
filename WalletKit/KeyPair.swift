...
public struct KeyPair {
    ...
    public var rootKeyPair: KeyPair {
        ...
        return derive(at: network.rootKeyPairPath)
    }
    
    /// Key identifier generated by PIREMD160 of SHA256 of public key.
    private var identifier: Data {
        return publicKeyData.hash160
    }
    
    /// Key fingure print generated by taking first 32 bits of key identifier.
    private var fingurePrint: UInt32 {
        return UInt32(bytes: identifier.bytes[0..<4])
    }
    ...
    public func derive(at path: String) -> KeyPair {
        ...
        paths.forEach { path in
            ...
            keyPair = keyPair.derive(at: index, hardens: hardens)
        }
