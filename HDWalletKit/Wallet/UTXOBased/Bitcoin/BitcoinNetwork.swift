...
public class BitcoinNetwork {
    public static let mainnet: BitcoinNetwork = BCHMainnet()
    public static let testnet: BitcoinNetwork = BCHTestnet()
    public static let mainnetBTC: BitcoinNetwork = BTCMainnet()
    public static let testnetBTC: BitcoinNetwork = BTCTestnet()
...
extension BitcoinNetwork: Equatable {
    // swiftlint:disable operator_whitespace
    public static func ==(lhs: BitcoinNetwork, rhs: BitcoinNetwork) -> Bool {
...
public class Mainnet: BitcoinNetwork {
...
public class Testnet: BitcoinNetwork {
    public override var name: String {
        return "testnet"
    }
    public override var alias: String {
